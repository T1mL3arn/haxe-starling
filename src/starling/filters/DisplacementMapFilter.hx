...
class DisplacementMapFilter extends FragmentFilter
{
    ...
    private static var sMapTexCoords:#if flash Vector<Float> #else Array<Float> #end = [];
	
    private static var sMatrix:Matrix3D = new Matrix3D();
    private static var sMatrixData:#if flash Vector<Float> #else Array<Float> #end = [];
                                          ...
                                          repeat:Bool=false)
    {
		...
		sMapTexCoords.push(0);
		sMapTexCoords.push(0);
		sMapTexCoords.push(1);
		sMapTexCoords.push(0);
		sMapTexCoords.push(0);
		sMapTexCoords.push(1);
		sMapTexCoords.push(1);
